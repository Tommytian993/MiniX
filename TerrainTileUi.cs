...
public partial class TerrainTileUi : Panel
{
     ...
     {
          // 依次加载每种地形的图片资源
          Texture2D plains = ResourceLoader.Load<Texture2D>("res://textures/terrain/plains.png") as Texture2D;
          Texture2D water = ResourceLoader.Load<Texture2D>("res://textures/terrain/water.png") as Texture2D;
          Texture2D desert = ResourceLoader.Load<Texture2D>("res://textures/terrain/desert.png") as Texture2D;
          Texture2D mountain = ResourceLoader.Load<Texture2D>("res://textures/terrain/mountain.png") as Texture2D;
          Texture2D shallowWater = ResourceLoader.Load<Texture2D>("res://textures/terrain/shallow_water.png") as Texture2D;
          Texture2D beach = ResourceLoader.Load<Texture2D>("res://textures/terrain/beach.png") as Texture2D;
          Texture2D forest = ResourceLoader.Load<Texture2D>("res://textures/terrain/forest.png") as Texture2D;
